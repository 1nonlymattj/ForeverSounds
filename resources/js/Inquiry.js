...
function InquiryDialog() {
    ...
    $('<div id = dialog align =center > ' + '<h3 class= inquiryNotice>' + message + '</h3>' + '<br>' +
        ...
        + '<input type= phone name= InquiryPhone class= form-control id= inquiryPhone placeholder= Phone required>' + '<br><br> '
        + '<input type= email name= InquiryEmail class= form-control id= inquiryEmail placeholder= Email required>' + '<br><br> ' +
        '<textarea name= InquiryMessage class= form-control-textfield rows = 5 col = 10 maxlength= 400 id= inquiryMessage placeholder= "Message" resize:none required></textarea>' + '<br><br><br>' +
        ' </form>' + ' </div>'
    ).dialog({
        ...
        buttons: {
            'Ok': {
                ...
                'id': 'confim',
                click: function () {
                    if (document.getElementById("inquiryName").value != "" && document.getElementById("inquiryPhone").value && document.getElementById("inquiryEmail").value != "" && document.getElementById("inquiryMessage").value != "") {
